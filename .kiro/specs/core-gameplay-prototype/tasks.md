...
- [ ] 1. 基础框架与配置层
  - [ ] 1.1 创建 GameConfig ScriptableObject 配置类
...
- [ ] 3. Checkpoint - 确保基础框架编译通过
  - 确保所有脚本编译无错误，ask the user if questions arise.

- [ ] 4. 输入与玩家移动
  - [ ] 4.1 实现 VirtualJoystick 虚拟摇杆
...
- [ ] 8. Checkpoint - 确保核心玩法逻辑编译通过
  - 确保所有脚本编译无错误，ask the user if questions arise.

- [ ] 9. 经验与升级系统
  - [ ] 9.1 实现 ExperienceSystem 经验金币管理
  ...
  - [ ] 9.7 实现 MetaUpgradeSystem 局外升级数据
...
- [ ] 11. UI 系统
  ...
  - [ ] 11.5 实现 SettlementPanel 结算面板
    - 创建 `Assets/Game/Scripts/UI/SettlementPanel.cs`
    - 显示本局感染总数、获得金币、获得经验
    - 点击继续按钮重置游戏开始新局
    - _Requirements: 10.1, 10.2, 10.3_

- [ ] 12. Checkpoint - 确保所有系统编译通过
  - 确保所有脚本编译无错误，ask the user if questions arise.

- [ ] 13. 系统集成与串联
  - [ ] 13.1 集成 GameSystemRunner 串联所有子系统
